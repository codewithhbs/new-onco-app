...
const AddressForm = ({ onClose, onSubmit, refresh }) => {
  ...
  const handleUseLocation = () => {
    ...
    setFormData((prevData) => ({
      ...
      city: location.weather.district || prevData.city,
      state: location.weather.city || prevData.state,
      pincode: String(location.weather.postalCode || prevData.pincode),
      stree_address: location.weather.completeAddress || prevData.stree_address,
      // house_no ko user khud fill kare, isliye yaha touch nahi kar rahe
    }));
  };
        ...
        <View style={styles.modalContent}>
          <View style={styles.modalHeader}>
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              {/* 👉 Get Location button yaha */}
              <TouchableOpacity
                onPress={handleUseLocation}
                style={styles.locationButton}
              >
                <Icon name="crosshairs-gps" size={18} color="#0A95DA" />
