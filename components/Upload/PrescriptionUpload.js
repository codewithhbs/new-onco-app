        ...
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.uploadButton} onPress={() => setModalVisible(true)} activeOpacity={0.8}>
                <View style={styles.buttonContent}>
                    <MaterialCommunityIcons name="upload" size={24} color="#010f16" style={styles.uploadIcon} />
                    ...
                    <MaterialCommunityIcons name="clipboard-text-outline" size={28} color="#054b6d" style={styles.prescriptionIcon} />
                </View>
            </TouchableOpacity>
